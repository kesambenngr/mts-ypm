...
`,D={root:function(t){var o=t.props,r=t.instance;return["p-badge p-component",{"p-badge-circle":z(o.value)&&String(o.value).length===1,"p-badge-dot":v(o.value)&&!r.$slots.default,"p-badge-sm":o.size==="small","p-badge-lg":o.size==="large","p-badge-xl":o.size==="xlarge","p-badge-info":o.severity==="info","p-badge-success":o.severity==="success","p-badge-warn":o.severity==="warn","p-badge-danger":o.severity==="danger","p-badge-secondary":o.severity==="secondary","p-badge-contrast":o.severity==="contrast"}]}},E=h.extend({name:"badge",style:F,classes:D}),L={name:"BaseBadge",extends:f,props:{value:{type:[String,Number],default:null},severity:{type:String,default:null},size:{type:String,default:null}},style:E,provide:function(){return{$pcBadge:this,$parentInstance:this}}},m={name:"Badge",extends:L,inheritAttrs:!1};function V(n,t,o,r,p,d){return u(),l("span",a({class:n.cx("root")},n.ptmi("root")),[b(n.$slots,"default",{},function(){return[I(y(n.value),1)]})],16)}m.render=V;var R=({dt:n})=>`
.p-button {
    display: inline-flex;
    cursor: pointer;
    user-select: none;
